...
<p class="mt-2">
Concpetually it's pretty simple. You can have all your terminal work done in a single 'window' and instead of having million tabs open in your terminal you can scope your tasks to sessions. For example you could have one session for all of your work tasks, another session for your personal projects, etc. 
</p>
